...
- The seed count is capped by `CRAWLER_MAX_PAGES`; staging uses twenty or fewer curated official pages.
...
| `CRAWLER_MAX_PAGES` | `20` | Hard cap on curated pages per run. |
